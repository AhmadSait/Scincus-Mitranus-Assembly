...
However, near the end of the notebook, the cells become more like instructions rather than code you can run. This is because due to some commands taking hours to run, I needed to put them in slurm files for them to run while my local machine is off. In these cases, I've highlighted that these commands were run in a terminal by saying "Ran in terminal" at the beginning of the cell.